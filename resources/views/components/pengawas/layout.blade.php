            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ $active == 'dashboard' ? 'active' : ''  }} ">
                        <a href="{{ route('pgws.dashboard.index') }}" class="menu-link">
                            <i class="menu-icon bx bxs-home"></i>
                            <div data-i18n="Analytics">Dashboard</div>
                        </a>
                    </li>
                    <li class="menu-item {{ ($open == 'Data') ? 'open active' : '' }} ">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item {{ $active == 'dataKendaraan' ? 'active' :'' }} ">
                                <a href="{{ route('pgws.kendaraan.index') }}" class="menu-link">
                                    <div data-i18n="Project Data">Data Kendaraan</div>
                                </a>
                            </li>
                            <li class="menu-item {{ $active == 'historySamsat' ? 'active' :'' }} ">
                                <a href="{{ route('pgws.samsat.index') }}" class="menu-link">
                                    <div data-i18n="Create Project">History Samsat</div>
                                </a>
                            </li>
