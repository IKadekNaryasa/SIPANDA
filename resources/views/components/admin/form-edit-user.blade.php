                    ...
                    <div class="form-item border p-3 mb-3 rounded" data-index="0">
                        <div class="row mb-1">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="nama" class="form-control" value="{{ $user->name ?? old('nama') }}" autofocus required placeholder="Nama Lengkap">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">NIP</label>
                                <input type="number" name="nip" class="form-control" value="{{ $user->nip ?? old('nip') }}" required placeholder="masukan NIP">
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="wa" class="form-control" value="{{ $user->wa ?? old('wa') }}" required placeholder="No WhatsApp (087xxx)">
                            </div>
                        </div>
                    </div>
                </div>
